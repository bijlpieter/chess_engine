...
Bitboard LOW_RANKS_BLACK = BB_RANKS[RANK_8] | BB_RANKS[RANK_7];
Bitboard LOW_RANKS_WHITE = BB_RANKS[RANK_1] | BB_RANKS[RANK_2];
...
Bitboard CENTRAL_FILES = BB_FILES[FILE_C] | BB_FILES[FILE_D] | BB_FILES[FILE_E] | BB_FILES[FILE_F];
Bitboard QUEEN_SIDE = BB_FILES[FILE_A] | BB_FILES[FILE_B]| BB_FILES[FILE_C] | BB_FILES[FILE_D];
Bitboard KING_SIDE = BB_FILES[FILE_E] | BB_FILES[FILE_F]| BB_FILES[FILE_G] | BB_FILES[FILE_H];

int SQUARE_DISTANCE[NUM_SQUARES][NUM_SQUARES];
